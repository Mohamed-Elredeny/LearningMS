                                ...
                                <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                                    ...
                                    <div class="btn-group" role="group">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                            <a class="btn btn-dark col-sm-12" href="{{route('users.show',['user'=>$admin->id])}}">عرض</a><br>
                                            <a class="btn btn-dark col-sm-12"  href="{{route('users.edit',['user'=>$admin->id])}}">تعديل</a>
                                            <form method="post" action="{{route('users.destroy',['user'=>$admin->id])}}">
                                                @csrf
                                                @method('DELETE')
