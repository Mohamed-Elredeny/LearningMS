    ...
    <div class="row">
        <div class="col-md-6 col-xl-3">
            <div class="card">
                <div class="card-body">
                    <div class="mini-stat">
                        <span class="mini-stat-icon bg-success float-left"><i class=" fas fa-user-graduate"></i></span>
                        <div class="mini-stat-info text-right">
                            <span class="counter text-primary">{{$usersNum}}</span>
                            عدد الطلاب
                        </div>
                    </div>
                </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="mini-stat clearfix">
                        <span class="mini-stat-icon bg-primary float-left"><i class="fas fas fa-user-edit"></i></span>
                        <div class="mini-stat-info text-right">
                            <span class="counter text-success">{{$teacherNum}}</span>
                            عدد المدرسين
                        </div>
        ...
        <div class="col-md-6 col-xl-3">
            <div class="card">
                <div class="card-body">
                    <div class="mini-stat clearfix">
                        <span class="mini-stat-icon bg-warning float-left"><i class=" typcn typcn-cog-outline"></i></span>
                        <div class="mini-stat-info text-right">
                            <span class="counter text-warning">{{$adminNum}}</span>
                            عدد المسؤلين
                        </div>
                        <div class="clearfix"></div>
                    </div>
        ...
        <div class="col-md-6 col-xl-3">
            <div class="card">
                <div class="card-body">
                    <div class="mini-stat clearfix">
                        <span class="mini-stat-icon bg-pink float-left"><i class="fas fa-code-branch "></i></span>
                        <div class="mini-stat-info text-right">
                            <span class="counter text-pink">{{$groupNum}}</span>
                            عدد المجموعات
                        </div>
                        <div class="clearfix"></div>
                    </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title mb-4">عدد الطلاب لكل مجموعة</h4>
