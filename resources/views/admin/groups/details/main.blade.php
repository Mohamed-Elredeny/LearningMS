...
@section("script")
    ...
    <script>
        ...
        var myDropzoneTheFirst = new Dropzone(
            ...
            '#file-dropzone', {
                url: 'https://el-dalil.net/admin/groups/images/add/' + x + '/' + groupId,
        ...
        var myDropzoneTheSecond = new Dropzone(
            ...
            '#file-dropzone8', {
                url: 'https://el-dalil.net/admin/groups/videos/add/' + y + '/' + groupId,
                acceptedFiles: ".mp4,.MOV,.WMV",
                addRemoveLinks: true,
                maxFilesize: 1000,
                timeout: 60*60*24*7*12*99,
                headers: {
                    'X-CSRF-TOKEN': "{{ csrf_token() }}"
                },
                removedfile: function(file)
        ...
        var myDropzoneThefile = new Dropzone(
            //id of drop zone element 2
            '#file-dropzonefile', {
                url: 'https://el-dalil.net/admin/groups/files/add/' + z + '/' + groupId,
                acceptedFiles: ".pdf",
                addRemoveLinks: true,
                maxFilesize: 150,
                headers: {
        ...
        var myDropzoneTheAudio = new Dropzone(
            //id of drop zone element 2
            '#file-dropzoneaudio', {
                url: 'https://el-dalil.net/admin/groups/audios/add/' + t + '/' + groupId,
