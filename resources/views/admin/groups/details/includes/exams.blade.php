<div id="exams" class="tab-pane fade in ">
    ...
    <center>
        <div class="row">
            ...
            <div class="col-sm-12">
                <center>
                    <a class="btn btn-dark col-sm-12" href="{{route('groupExams.create',['id'=>$id,'type'=>'exam'])}}" target="_blank">اضافة اختبار جديد</a>
                </center>
            </div>
                    ...
                    <div class="card text-center">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row text-center ">
                                <center>
                                    <a href="{{route('groupExams.show',['groupExam'=>$exam->id])}}" class="btn btn-dark col-sm-5" target="_blank">عرض الامتحان</a>
                                    @if($exam->is_publisher == 0)
                                        <a href="{{route('groupExams.publishOrHide',['type'=>'show','id'=>$exam->id])}}" class="btn btn-dark col-sm-5 ml-1">نشر</a>
                                    @else
                                        <a href="{{route('groupExams.publishOrHide',['type'=>'hide','id'=>$exam->id])}}" class="btn btn-dark col-sm-5 ml-1">اخفاء</a>
                                    @endif
