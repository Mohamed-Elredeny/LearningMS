<div id="quiz" class="tab-pane fade in ">
    ...
    <center>
        <div class="row">
            ...
            <div class="col-sm-12">
                <center>
                    <a class="btn btn-dark col-sm-12" href="{{route('groupExams.create',['id'=>$id,'type'=>'quiz'])}}" target="_blank">اضافة كويز جديد</a>
                </center>
            </div>
                    ...
                    <div class="card text-center">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row text-center ">
                                <center>
                                    <a href="{{route('groupExams.show',['groupExam'=>$exam->id])}}" class="btn btn-dark col-sm-5" target="_blank">عرض الكويز</a>
