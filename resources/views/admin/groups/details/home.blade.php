                ...
                @if($post->publisher_type == 'admin')
                    <div class="d-flex justify-content-between">
                        <div class="media mb-5">
                            <img class="d-flex mr-3 rounded-circle avatar-sm" src='{{asset("assets/images/admins")}}/{{$post->groupsTeacher->admin->image}}' alt="Generic placeholder image">
                            <div class="media-body">
                                <h4 class="font-size-14 m-0">{{$post->groupsTeacher->admin->name}}</h4>
                                <small class="text-muted">{{$post->groupsTeacher->admin->email}}</small>
                                <br>
