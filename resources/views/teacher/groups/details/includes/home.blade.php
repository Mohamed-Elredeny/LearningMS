                        ...
                        <div class="btn-group" role="group" aria-label="Button group with nested dropdown">
                            ...
                            <div class="btn-group" role="group">
                                ...
                                <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                    @if($post->is_publisher == 1)
                                    <a class="btn btn-dark col-sm-12"  href="{{route("teacher.groups.postSare", ['id'=>$post->id])}}">عدم النشر</a>
                                    @elseif($post->is_publisher == 0)
                                    <a class="btn btn-dark col-sm-12"  href="{{route("teacher.groups.postSare", ['id'=>$post->id])}}"> النشر</a>
                                    @endif
                                    ...
                                    <a class="btn btn-dark col-sm-12"  href="{{route('teachergroups.postDelete', ['id'=>$post->id])}}">حذف</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="modal " id="share`+x+`" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{route('teacher.groups.shareToGroup')}}" method="post">
                                @csrf
