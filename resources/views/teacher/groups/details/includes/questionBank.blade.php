<div id="questionBank" class="tab-pane fade in ">
    ...
    <center>
        <div class="row">
            ...
            <div class="col-sm-12">
                <center>
                    <a class="btn btn-dark col-sm-12" href="{{route('teacher.groupExams.create',['id'=>$id,'type'=>'questionBank'])}}" target="_blank">اضافة بنك اسئلة جديد</a>
                    ...
                    <div class="card text-center">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row text-center ">
                                <center>
                                    <a href="{{route('teacherGroupExams.show',['teacherGroupExam'=>$exam->id])}}" class="btn btn-dark col-sm-5" target="_blank">عرض الكويز</a>
